...
export default {
  ...
  data() {
    return {
      card1: {
        image: '/demo-app/statics/mocks/rewards/pizza.jpg',
        title: 'free doughballs',
        logo: '/demo-app/statics/brand-logos/mamma-mia.png',
      ...
      card2: {
        image: '/demo-app/statics/mocks/rewards/theme-park.jpg',
        title: 'two kids free',
        logo: '/demo-app/statics/brand-logos/jungle-park.png',
      ...
      card3: {
        image: '/demo-app/statics/mocks/rewards/orange.jpg',
        title: 'free can of zesti',
        logo: '/demo-app/statics/brand-logos/zesti.png',
      ...
      card4: {
        image: '/demo-app/statics/mocks/rewards/clothes.jpg',
        title: '20% off',
        logo: '/demo-app/statics/brand-logos/kooku.png',
